...
package com.example.nav.listget.DragSort;
...
public class DragSortListView extends ListView {
	...
	private class AdapterWrapper extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				if (grandChild instanceof Checkable) {
		...
		public void onStart() {
			...
			if (mUseRemoveVelocity) {
				...
				if (mRemoveVelocityX == 0) {
					...
					minVelocity *= 2;
					if(mRemoveVelocityX < 0){
						if (mRemoveVelocityX > -minVelocity){
	 ...
	 * through to {@link com.example.nav.listget.DragSort.DragSortListView.DropListener#drop(int, int)}.
	 * 
	...
	public interface FloatViewManager {
		 ...
		 * and the offset provided in {@link com.example.nav.listget.DragSort.DragSortListView#startDrag}.
	 ...
	 * {@link com.example.nav.listget.DragSort.DragSortListView.DragScrollProfile}.
	 * 
	 * @param ssp
	 */
	 ...
	 * {@link com.example.nav.listget.DragSort.DragSortListView#setDragScrollProfile(com.example.nav.listget.DragSort.DragSortListView.DragScrollProfile)} to
	 * set custom profile.
	 * 
	 * @author heycosmo
	 *
